...
test-pw-project: ## Run E2E tests in a container
...
test-pw-ui: ## Run E2E tests in a container
	@docker compose exec e2e sh -c "npm install -y --silent && npx playwright test $(filter-out $@,$(MAKECMDGOALS)) --ui"
%:
	@:
