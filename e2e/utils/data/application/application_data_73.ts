 ...
 */
const baseFormUnRegisteredCommunity_73: FormData = createFormData(
  baseForm_73,
  {
    formPages: {
      "1_hakijan_tiedot": {
 ...
 *
 */
const registeredCommunityApplications_73 = {
  draft: baseForm_73,
  missing_values: createFormData(baseForm_73, missingValues),
  wrong_values: createFormData(baseForm_73, wrongValues),
  success: createFormData(baseForm_73, sendApplication),
}
 ...
 * Each keyed formdata in this object will result a new test run for this form.
 */
const unRegisteredCommunityApplications_73 = {
  draft: baseFormUnRegisteredCommunity_73,
  missing_values: createFormData(baseFormUnRegisteredCommunity_73, missingValuesUnregistered),
  wrong_values: createFormData(baseFormUnRegisteredCommunity_73, wrongValuesUnregistered),
  success: createFormData(baseFormUnRegisteredCommunity_73, sendApplication),
}

export {
  registeredCommunityApplications_73,
  unRegisteredCommunityApplications_73
}
