 ...
 */
const baseFormPrivatePerson_29: FormData = {
  title: 'Success',
...
const baseFormRegisteredCommunity_29: FormData = {
  title: 'Form submit',
  formSelector: formSelector,
  formPath: formPath,
  formPages: {
...
const baseFormUnRegisteredCommunity_29: FormData = {
  title: 'Form submit',
  formSelector: formSelector,
  formPath: formPath,
  formPages: {
...
const registeredCommunityApplications_29 = {
  // success: baseFormRegisteredCommunity_29,
  draft: createFormData(baseFormRegisteredCommunity_29, saveDraft),
}
