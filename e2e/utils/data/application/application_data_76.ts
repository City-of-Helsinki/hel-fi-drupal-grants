 ...
 */
const baseFormRegisteredCommunity_76: FormData = {
  title: 'Save as draft.',
 ...
 * Private person.
 */
const baseFormPrivatePerson_76: FormData = createFormData(
  baseFormRegisteredCommunity_76,
  {
 ...
 */
const baseFormUnRegisteredCommunity_76: FormData = createFormData(
  baseFormRegisteredCommunity_76,
  {
    validateTooltips: false,
    formPages: {
 ...
 */
const privatePersonApplications_76 = {
  draft: baseFormPrivatePerson_76,
  missing_values: createFormData(baseFormPrivatePerson_76, missingValuesPrivateUnregistered),
  success: createFormData(baseFormPrivatePerson_76, sendApplication),
}
 ...
 * Each keyed formdata in this object will result a new test run for this form.
 */
const unRegisteredCommunityApplications_76 = {
  draft: baseFormUnRegisteredCommunity_76,
  missing_values: createFormData(baseFormUnRegisteredCommunity_76, missingValuesPrivateUnregistered),
  success: createFormData(baseFormUnRegisteredCommunity_76, sendApplication),
}

export {
  registeredCommunityApplications_76,
  privatePersonApplications_76,
  unRegisteredCommunityApplications_76
}
