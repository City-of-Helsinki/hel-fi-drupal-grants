 ...
 */
const baseFormRegisteredCommunity_77: FormData = {
  title: 'Save as draft.',
  formSelector: 'webform-submission-nuorisotoiminta-projektiavustus-form',
  formPath: '/fi/form/nuorisotoiminta-projektiavustus',
  formPages: {
    "1_hakijan_tiedot": {
      items: {
        "edit-email": {
    ...
    "2_avustustiedot": {
      items: {
        ...
        "edit-start-subvention-applied": {
          role: 'radio',
          selector: {
            type: 'dom-id-label',
            name: 'data-drupal-selector',
            value: 'edit-start-subvention-applied-1',
          },
          value: "Ei",
    ...
    "projektisuunnitelma": {
      items: {
        ...
        "edit-projekti-alkaa": {
          ...
          viewPageSelector: '#nuorisotoiminta_projektiavustus--projektin_aikataulu',
        },
  ...
  expectedErrors: {},
  expectedDestination: "/fi/hakemus/nuorisotoiminta_projektiavustus/",
}
 ...
 */
const baseFormUnRegisteredCommunity_77: FormData = createFormData(
  baseFormRegisteredCommunity_77,
  {
    formPages: {
      "1_hakijan_tiedot": {
        items: {
...
const missingValues: FormDataWithRemoveOptionalProps = {
  ...
  expectedErrors: {
    ...
    'edit-jasenet-0-6-vuotiaat': 'Virhe sivulla 3. Aktiiviset osallistujat ja jäsenet: 0 - 6 vuotiaat kenttä on pakollinen.',
    'edit-0-6-joista-helsinkilaisia': 'Virhe sivulla 3. Aktiiviset osallistujat ja jäsenet: joista helsinkiläisiä kenttä on pakollinen.',
    'edit-jasenet-7-28-vuotiaat': 'Virhe sivulla 3. Aktiiviset osallistujat ja jäsenet: 7 - 28 vuotiaat kenttä on pakollinen.',
    'edit-7-28-joista-helsinkilaisia': 'Virhe sivulla 3. Aktiiviset osallistujat ja jäsenet: joista helsinkiläisiä kenttä on pakollinen.',
    'edit-muut-jasenet-tai-aktiiviset-osallistujat': 'Virhe sivulla 3. Aktiiviset osallistujat ja jäsenet: Muut osallistujat kenttä on pakollinen.',
    'edit-muut-joista-helsinkilaisia': 'Virhe sivulla 3. Aktiiviset osallistujat ja jäsenet: joista helsinkiläisiä kenttä on pakollinen.',
    ...
    'edit-osallistujat-7-28': 'Virhe sivulla 4. Projektisuunnitelma: Kuinka monta alle 29-vuotiasta helsinkiläistä projektiin osallistuu? kenttä on pakollinen.',
    'edit-osallistujat-kaikki': 'Virhe sivulla 4. Projektisuunnitelma: Kuinka paljon projektiin osallistujia on yhteensä? kenttä on pakollinen.',
  },
};
...
const registeredCommunityApplications_77 = {
  draft: baseFormRegisteredCommunity_77,
  missing_values: createFormData(baseFormRegisteredCommunity_77, missingValues),
  wrong_values: createFormData(baseFormRegisteredCommunity_77, wrongValues),
  success: createFormData(baseFormRegisteredCommunity_77, sendApplication),
}
 ...
 */
const unRegisteredCommunityApplications_77 = {
  draft: baseFormUnRegisteredCommunity_77,
  missing_values: createFormData(baseFormUnRegisteredCommunity_77, missingValuesUnregistered),
  wrong_values: createFormData(baseFormUnRegisteredCommunity_77, wrongValuesUnregistered),
  success: createFormData(baseFormUnRegisteredCommunity_77, sendApplication),
}

export {
  registeredCommunityApplications_77,
  unRegisteredCommunityApplications_77
}
