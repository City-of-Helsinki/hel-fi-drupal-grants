...
namespace Drupal\Tests\grants_news_importer\Kernel\Plugin\migrate\source;

use Drupal\KernelTests\KernelTestBase;
use Drupal\migrate\Plugin\MigrateSourcePluginManager;
use Drupal\migrate\Plugin\MigrationInterface;
use Drupal\migrate\Plugin\MigrationPluginManagerInterface;
use Drupal\grants_news_importer\Plugin\migrate\source\ImportedArticle;
use Drupal\Tests\helfi_api_base\Traits\ApiTestTrait;
use Drupal\Tests\grants_news_importer\Traits\ImportedArticleTestTrait;
use GuzzleHttp\Psr7\Response;

/**
 * Tests ImportedArticle source plugin.
 *
 * @coversDefaultClass \Drupal\grants_news_importer\Plugin\migrate\source\ImportedArticle
 * @group grants_news_importer
 */
class ImportedArticleTest extends KernelTestBase {
  ...
  public function testSourcePlugin() : void {
    ...
    /** @var \Drupal\grants_news_importer\Plugin\migrate\source\ImportedArticle */
