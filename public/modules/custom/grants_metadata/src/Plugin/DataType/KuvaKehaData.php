...
/**
 * DataType Kuvakeha application.
 *
 * @DataType(
 * id = "grants_metadata_kuvakeha",
 * label = @Translation("Kulttuurin kehittämisavustukset"),
 * definition_class =
 *   "\Drupal\grants_metadata\TypedData\Definition\KuvaKehaDefinition"
 * )
 */
class KuvaKehaData extends Map {
