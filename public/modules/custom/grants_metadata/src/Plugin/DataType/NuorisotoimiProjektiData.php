 ...
 *
 * @DataType(
 * id = "grants_metadata_nuorisotoimiprojekti",
 * label = @Translation("Nuorisotoiminnan projektiavustushakemus"),
 * definition_class =
 *   "\Drupal\grants_metadata\TypedData\Definition\NuorisotoimiProjektiDefinition"
 * )
 */
class NuorisotoimiProjektiData extends Map {
