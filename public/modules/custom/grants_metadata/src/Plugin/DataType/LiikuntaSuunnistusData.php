 ...
 *
 * @DataType(
 * id = "grants_metadata_liikuntasuunnistus",
 * label = @Translation("Liikunta, Suunnistuskartta-avustushakemus"),
 * definition_class =
 *   "\Drupal\grants_metadata\TypedData\Definition\LiikuntaSuunnistusDefinition"
 * )
 */
class LiikuntaSuunnistusData extends Map {
