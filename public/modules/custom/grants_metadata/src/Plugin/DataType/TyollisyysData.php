 ...
 *
 * @DataType(
 * id = "grants_metadata_tyollisyys",
 * label = @Translation("Työllisyysavustushakemus"),
 * definition_class =
 *   "\Drupal\grants_metadata\TypedData\Definition\TyollisyysDefinition"
 * )
 */
class TyollisyysData extends Map {
