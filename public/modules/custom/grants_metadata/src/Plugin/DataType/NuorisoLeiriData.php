 ...
 *
 * @DataType(
 * id = "grants_metadata_nuorisoleiri",
 * label = @Translation("Nuoriso leiri"),
 * definition_class =
 *   "\Drupal\grants_metadata\TypedData\Definition\NuorisoLeiriDefinition"
 * )
 */
class NuorisoLeiriData extends Map {
