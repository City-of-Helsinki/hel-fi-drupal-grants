 ...
 *
 * @DataType(
 * id = "grants_metadata_sotepeyleis",
 * label = @Translation("Sosiaali-, terveys- ja pelastustoimen yleisavustus"),
 * definition_class =
 *   "\Drupal\grants_metadata\TypedData\Definition\SotepeyleisDefinition"
 * )
 */
class SotepeYleisData extends Map {
