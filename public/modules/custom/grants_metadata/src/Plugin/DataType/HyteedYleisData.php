 ...
 *
 * @DataType(
 * id = "grants_metadata_hyteedyleis",
 * label = @Translation("Hyvinvoinnin ja terveyden edistämisen yleisavustus"),
 * definition_class =
 *   "\Drupal\grants_metadata\TypedData\Definition\HyteedyleisDefinition"
 * )
 */
class HyteedYleisData extends Map {
