 ...
 * label = @Translation("Hyvinvoinnin ja terveyden edistämisen pienavustus"),
 * definition_class =
 *   "\Drupal\grants_metadata\TypedData\Definition\HyteedPienDefinition"
 * )
 */
class HyteedPienData extends Map {
